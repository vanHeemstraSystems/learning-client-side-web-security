...
Initiative: **Master Client-Side Web Security**
...
Hence, mastering client-side web security has been successful if we either ```learn how to do it properly``` or we ```succeed in understanding it completely```. 
